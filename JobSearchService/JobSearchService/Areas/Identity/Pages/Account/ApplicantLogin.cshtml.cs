...
namespace JobSearchService.Areas.Identity.Pages.Account
{
    ...
    public class ApplicantLoginModel : PageModel
    {
        ...
        public ApplicantLoginModel(SignInManager<ApplicationUser> signInManager, ILogger<ApplicantLoginModel> logger, UserManager<ApplicationUser> userManager, JobSearchService.Data.ApplicationDbContext context)
        {
