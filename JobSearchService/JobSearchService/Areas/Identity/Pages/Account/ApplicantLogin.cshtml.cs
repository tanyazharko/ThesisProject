...
namespace JobSearchService.Areas.Identity.Pages.Account
{
    ...
    public class ApplicantLoginModel : PageModel
    {
        ...
        public ApplicantLoginModel(SignInManager<ApplicationProfile> signInManager,ILogger<ApplicantLoginModel> logger, UserManager<ApplicationProfile> userManager,ApplicationDbContext context)
        {
